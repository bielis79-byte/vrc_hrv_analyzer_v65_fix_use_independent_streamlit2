...
st.set_page_config(page_title="VRC / HRV RRi Analyzer Pro v6.5 Kubios Mode", layout="wide")
...
st.title("VRC / HRV RRi Analyzer Pro v6.5 · Kubios Mode")
st.caption("Segmentación tipo Kubios, dominios y MSE mejorados, Poincaré en paneles, HVG e informe automático. Fix v6.5.")
...
with st.sidebar.expander("Segmentación", expanded=True):
    use_independent = st.checkbox("Ventanas independientes por registro", value=st.session_state.get("use_independent_v65", False), key="use_independent_checkbox_v65")
    st.session_state.use_independent_v65 = use_independent
...
# Variables de segmentación seguras antes del cálculo central.
# En versiones previas podían definirse dentro de un bloque posterior y causar NameError.
if "use_independent_v65" not in st.session_state:
    st.session_state.use_independent_v65 = False

use_independent = st.session_state.use_independent_v65
